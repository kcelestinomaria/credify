...
@section('title', 'Create Institutional Admin')

@section('content')
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-lg font-medium text-gray-900">Create New Institutional Admin</h3>
            ...
            <form action="{{ route('institutional-admins.store') }}" method="POST" class="space-y-6">
                @csrf
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <ul class="list-disc list-inside space-y-1">
                                    <li>A temporary password will be automatically generated for this admin</li>
                                    <li>The admin will be required to change their password on first login</li>
                                    <li>You will receive the temporary password after creating the admin</li>
                                    <li>Please provide the temporary password securely to the admin</li>
                                </ul>
                            </div>
                        </div>
                    </div>
